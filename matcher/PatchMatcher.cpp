...
{}
int PatchMatcher::match(ImageExtractData* const _frame1, ImageExtractData* const _frame2, ImageMatchData* const _result)
{
	if (!_result || !_frame1 || !_frame2 || _result->usePatchMatch || _frame1->usePointFeature || _frame2->usePointFeature)
		return -1;

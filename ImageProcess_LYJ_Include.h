...
namespace ImageProcess_LYJ
{
	...
	IMAGEPROCESS_LYJ_API void pairGenerate(std::vector<ImageExtractData>& _frames, std::vector<ImageMatchData>& _matchDatas, const ImagePairOption& _opt = ImagePairOption());
